...
<html lang="en">
    <head>
        ...
        <title><?php echo $mrmonkServer; ?> | Clear Warehouse Password </title>
    ...
    <body>
              ...
              <ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
					...
					<li class="active"><a href="ClearWh.php">Clear WarehousePass</a></li>
                  </ul>
                </li>
				<li class="dropdown">
        ...
        <div class="breadcrumb-holder">
            <div class="container">
                <ol class="breadcrumb">
                  <li><a href="../">Home</a></li>
                  <li class="active">ClearWarehouse Password</li>
                </ol>
            </div>
        </div>
            ...
            <div class="fields">
                <div class="container">
                    <div class="row">
                        ...
                        <h2 class="h1">&quot; ClearWarehouse Password &quot;</h2>
                        ...
                        <form method='post' action=''>
                            <div class="col-md-6 wow bounceInLeft" data-wow-duration="1s" data-wow-offset="400">
								...
								<div class="form-group">
                                    <input name="Email" type="eamil" class="form-control input-lg" placeholder="E-Mail">
                                </div>
                                <button  type="submit" name="submit" class="btn btn-danger btn-lg btn-block">Clear</button>
								<p>&nbsp;</p>
								<?php
			if (isset($submit)) {
########################### by Mr.Monk ##############################
			...
			{ $errors .= "<bb><font color='red'><div class='trix2'><center>Email did not match.</center></div></font><br /></bb> \n"; }
			$query = mysql_query("SELECT Username FROM accounts WHERE Username='".$Username."' and Email='".$Email."'");
			if(mysql_num_rows($query) != 1)
			{ $errors .= "<bb><font color='red'><div class='trix2'><center>Email is wrong !.</center></div></font><br /></bb> \n"; }
			...
			$success=mysql_query("UPDATE entities SET WarehousePW='".$MrMonk."' WHERE Owner='".$Username."'")or die(mysql_error());
			}
			if($success) {
			echo"<font color='lime'><div class='trix2'><center>Password WarehousePW has been Cleared successfully !.</center></div></font><br />";
			}
			}
			?>
									<center>							</div>							
