...
<html lang="en">
    <head>
        ...
        <title><?php echo $mrmonkServer; ?> | Forget E-Mail </title>
    ...
    <body>
              ...
              <ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
					...
					<li class="active"><a href="ForgetEmail.php">ForgetE-Mail</a></li>
        ...
        <div class="breadcrumb-holder">
            <div class="container">
                <ol class="breadcrumb">
                  <li><a href="../">Home</a></li>
                  <li class="active">Forget E-Mail</li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <form method='post' action=''>
                            <div class="col-md-6 wow bounceInLeft" data-wow-duration="1s" data-wow-offset="400">
								...
								<div class="form-group">
                                    <input name="mobilenumber" type="text" class="form-control input-lg" placeholder=" MobileNumber ">
                                </div>
								<div class="form-group">
                                    <input name="Email" type="email" class="form-control input-lg" placeholder="New E-Mail">
                                </div>
								<div class="form-group">
                                    <input name="email2" type="email" class="form-control input-lg" placeholder="Confirm New E-Mail">
                                </div>
...
########################### by Mr.Monk ##############################
			...
			{ $errors .= "<bb><font color='red'><div class='trix2'><center>New Email did not match.</center></div></font><br /></bb> \n"; }
			$query = mysql_query("SELECT Username FROM accounts WHERE Username='".$Username."' and mobilenumber='".$mobilenumber."'");
			if(mysql_num_rows($query) != 1)
			{ $errors .= "<bb><font color='red'><div class='trix2'><center>MobileNumber you entered was incorrect.</center></div></font><br /></bb> \n"; }
			...
			$success=mysql_query("UPDATE accounts SET Email='".$Email."' WHERE Username='".$Username."'")or die(mysql_error());
			}
			if($success) {
			echo"<font color='lime'><div class='trix2'><center>Email has been change successfully !.</center></div></font><br />";
			}
			}
			?>
							 <center>							</div>							
