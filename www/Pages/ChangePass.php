...
<html lang="en">
    <head>
        ...
        <title><?php echo $mrdaanyServer; ?> | ChangePassword </title>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand wobble-horizontal" href="https://www.facebook.com/daany1022<?php echo $mrdaanyFace; ?>">Server :Daany <span><?php?></span></a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li class="active"><a href="ChangePass.php">ChangePass</a></li>
				...
				<li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
					...
					<li><a href="contact.php">Contact</a></li>
                     <li><a href="<?php echo $mrdaanyFroum; ?>" target="_blank">Forum</a></li>
                    <li class="divider"></li>
                    ...
                    <div class="row">
                        ...
                        <form method='post' action=''>
                            <div class="col-md-6 wow bounceInLeft" data-wow-duration="1s" data-wow-offset="400">
								...
								<div class="form-group">
                                    <input name="oldpassword" type="Password" class="form-control input-lg" placeholder="Old Password">
                                </div>
								<div class="form-group">
                                    <input name="newpassword" type="Password" class="form-control input-lg" placeholder="New Password">
                                </div>
								<div class="form-group">
                                    <input name="newpassword2" type="password" class="form-control input-lg" placeholder="Confirm New Password">
                                </div>
                                <button  type="submit" name="submit" class="btn btn-danger btn-lg btn-block">Change</button>
								<p>&nbsp;</p>
								<?php
			if (isset($submit)) {
########################### by Mr.daany ##############################
			mysql_select_db($mrdaanyDB);
			...
			$query = mysql_query("SELECT Username FROM accounts WHERE Username='".$Username."' and Password='".$oldpassword."'");
			if(mysql_num_rows($query) != 1)
			{ $errors .= "<bb><font color='red'><div class='trix2'><center>Username Or OldPassword you entered was incorrect.</center></div></font><br /></bb> \n"; }
			...
			$success=mysql_query("UPDATE accounts SET Password='".$newpassword."' WHERE Username='".$Username."'")or die(mysql_error());
			}
			if($success) {
